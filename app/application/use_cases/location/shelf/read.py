...
async def _get_shelf_for_library(
	...
	await _get_section_for_library(section_repo, bookcase_repo, shelf.section_id, library_id)
	return shelf
...
class GetShelfUseCase:
	...
	async def execute(self, shelf_id: UUID, library_id: UUID) -> Shelf:
		return await _get_shelf_for_library(
