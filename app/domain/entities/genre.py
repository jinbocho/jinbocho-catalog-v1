...
_KEYWORDS: list[tuple[Genre, tuple[str, ...]]] = [
	(
		...
		("science fiction", "sci-fi", "scifi", "fantascienza", "ciencia ficcion", "ciencia ficción"),
	),
	(Genre.YOUNG_ADULT, ("young adult", "adolescen", "teen", "ya ")),
	(
		Genre.MYSTERY_THRILLER,
		("mystery", "thriller", "crime", "detective", "giallo", "noir", "suspense", "polar", "policiaco", "policíaco"),
	),
	(Genre.BIOGRAPHY_MEMOIR, ("biograph", "biografi", "memoir", "autobiograf", "memorias")),
	(
		Genre.HISTORICAL,
		("historical fiction", "historical novel", "romanzo storico", "novela historica", "novela histórica"),
	),
	(
		Genre.SELF_HELP,
		(
	...
	(
		Genre.COMICS,
		("comic", "graphic novel", "fumetto", "manga", "bande dessinee", "bande dessinée", "historieta", "tebeo"),
	),
	...
	(
		Genre.ART,
		("art", "arte", "music", "musica", "música", "photograph", "fotograf", "design", "cinema", "film"),
	),
	(Genre.POETRY, ("poetry", "poesia", "poesía", "poesie", "poésie", "poem")),
	(Genre.DRAMA, ("drama", "teatro", "theatre", "theater", "théâtre", "play")),
	(
		Genre.CHILDREN,
		("children", "juvenile", "bambini", "kids", "picture book", "infantil", "enfant", "ragazzi"),
	),
	(Genre.TRAVEL, ("travel", "viaggi", "voyage", "viajes", "guide", "guida")),
	(
		Genre.COOKING,
		("cook", "cucina", "cuisine", "cocina", "food", "recipe", "ricett", "recett", "gastronom"),
	),
